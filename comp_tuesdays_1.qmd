...
p <- 0.5
n <- 100
k <- 1:100 # these are all the possible outcomes
the_product<-0
the_ways_to_choose <- 0
ultipl_the_two <- 0
...
plot(k,dbinom(1:100, 100, 0.5)) # this is 1d
...
likelihood_values <- sapply(p_values, function(p) likelihood_binomial(p, 271, 630))
