...
without_ratings_pred_belief$time_point <-  recode_factor(test$time_point, exp = "expectation", belief = "outcome")
without_ratings_pred_belief $measure <-  recode_factor(test$measure, value = "certainty_value")
...
with_ratings_pred_belief $time_point <-  recode_factor(test$time_point, exp = "expectation", belief = "outcome")
with_ratings_pred_belief $measure <-  recode_factor(test$measure, value = "certainty_value")
...
plot_without <-plot_without + 
  ggtitle("Feared Predictions and Outcomes *without* SFA and SB" ) +
   labs(x= "Time Point", y="Conviction (%)")
...
plot_with <- with_ratings_pred_belief %>% 
  ...
  theme(legend.position = "none") 
plot_with <-plot_with + 
  ggtitle("Feared Predictions and Outcomes *with* SFA and SB" )+
   labs(x= "Time Point", y="Conviction (%)")
...
anx_change_plot <- ggplot(data = osca_dep_anx_long , aes(x = time_point , y = lsas_values, group = id, color=factor(id),alpha=0.8)) +
  ...
  ggtitle("Changes in Social Anxiety Symptoms During Treatment of Social Anxiety")
legend.position = "none"
anx_change_plot <- anx_change_plot+
  theme(legend.position = "none")
anx_change_plot <- anx_change_plot +
