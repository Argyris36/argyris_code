...
```{r, echo = FALSE}
dep_change_plot <- ggplot(data = osca_dep_anx_long , aes(x = time_point , y = mfq_values, group = id, color=factor(id),alpha=1)) +
  geom_line( size = 2) +
  geom_point( size = 4) +
  xlab("time") + ylab("mfq") +
  ggtitle("Changes in Depression During Treatment")
legend.position = "none"
...
```{r}
anx_change_plot <- ggplot(data = osca_dep_anx_long , aes(x = time_point , y = lsas_values, group = id, color=factor(id),alpha=1)) +
  geom_line( size = 2) +
  geom_point( size = 4) +
  xlab("time") + ylab("mfq") +
  ggtitle("Changes in Anxiety During Treatment")
legend.position = "none"
anx_change_plot <- anx_change_plot+
  theme(legend.position = "none")
anx_change_plot +
